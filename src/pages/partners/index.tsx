    ...
    <>
      ...
      <Center>
        <Box w={'75%'} maxW={'1200px'}>
          <HomeHeader />
          <Text textAlign={'center'} fontWeight={600} fontSize={'46px'} mb={6}>
            Партнеры
          </Text>
          <List>
            <ListItem>
              <Stack direction={'row'} alignItems={'self-start'} mb={8}>
                <Box minW={'40%'}>
                  <Img
                    w={'200px'}
                ...
                <Box>
                  <Text textAlign={'left'} fontSize={'22px'} fontWeight={600} mb={4}>
                    АйТИ БАСТИОН
                  </Text>
                  <Text mb={3}>
                    ...
                    системы контроля действий ИТ-поставщиков СКДПУ с Центром мониторинга и
                    аналитики, модулем отчётности, модулем отказоустойчивости и масштабирования,
                    модулем профилирования пользователей. Эта система обеспечивает всю
                    функциональность PAM – от входа пользователя в систему до «умного» анализа
                    потенциального инцидента. СКДПУ НТ внесен в Реестр отечественного ПО и
                    сертифицирован ФСТЭК России. На начало 2022 года заказчики «АйТи Бастион» –
                    более 140 российских компаний из разных отраслей, в том числе нефтегазовой,
                    энергетической, банковской, организаций государственного сектора, ритейла и
                    медицины.
                  </Text>
            ...
            <ListItem>
              <Stack direction={'row'} alignItems={'self-start'} mb={8}>
                <Box minW={'40%'}>
                  <Img
                    w={'200px'}
                    src="/media/images/landing/searchInform_logo.svg"
                    alt=""
                    marginLeft={'auto'}
                    marginRight={'20px'}
                  />
              ...
              <Stack direction={'row'} alignItems={'self-start'} mb={8}>
                ...
                <Box>
                  ...
                  <Text mb={3}>
                    ...
                    Продукты компании применяются для защиты конфиденциальной информации,
                    коммерческой тайны, персональных данных и сведений, составляющих государственную
                    тайну.
                  </Text>
            ...
            <ListItem>
              <Stack direction={'row'} alignItems={'self-start'} mb={8}>
                ...
                <Box>
                  ...
                  <Text mb={3}>
                    Киберпротект — российский разработчик ПО для защиты данных, резервного
                    копирования и восстановления виртуальных, физических и облачных сред. Мы
                    предоставляем масштабируемые решения мирового уровня для надежной киберзащиты,
                    быстрого восстановления данных и гарантии отказоустойчивости информационных
                    систем.
                  </Text>
              ...
              <Stack direction={'row'} alignItems={'self-start'} mb={8}>
                ...
                <Box>
                  ...
                  <Text mb={3}>
                    ...
                    компании является офисный пакет «Р7-Офис», который входит в Реестр
                    отечественного ПО.
                  </Text>
              ...
              <Stack direction={'row'} alignItems={'self-start'} mb={8}>
                ...
                <Box>
                  ...
                  <Text mb={3}>
                    ...
                    данных, охватывающих вопросы сбора, интеграции, очистки данных, построения
                    моделей и визуализации.
                  </Text>
              ...
              <Stack direction={'row'} alignItems={'self-start'} mb={8}>
                ...
                <Box>
                  ...
                  <Text mb={3}>
                    ...
                    российском IT-рынке. Разработчиком, владельцем бренда и крупнейшим
                    дистрибьютором является компания Тайле. Под маркой нашего бренда мы поставляем
                    компоненты для построения оптических линий любой сложности.
                  </Text>
              ...
              <Stack direction={'row'} alignItems={'self-start'} mb={8}>
                ...
                <Box>
                  ...
                  <Text mb={3}>
                    ...
                    данных и виртуализации. Ведущими продуктами и решениями компании являются
                    системы хранения данных АЭРОДИСК ENGINE, АЭРОДИСК Восток и гиперконвергентная
                    система АЭРОДИСК vAIR. Программное обеспечение АЭРОДИСК зарегистрировано в
                    Роспатенте, Минпромторге и в реестре отечественного ПО Министерства цифрового
            ...
            <ListItem>
              <Stack direction={'row'} alignItems={'self-start'} mb={8}>
                ...
                <Box>
                  ...
                  <Text mb={3}>
                    Крупнейшая российская компания на рынке IT, бытовой техники, канцелярских
                    товаров и офисной мебели.
                  </Text>
              ...
              <Stack direction={'row'} alignItems={'self-start'} mb={8}>
                ...
                <Box>
                  ...
                  <Text mb={3}>
                    ...
                    области внедрения цифровых технологий в России. Компания DEPO Computers
                    производит российские высокотехнологичные клиентские устройства, серверное и
                    инфраструктурное оборудование, а также внедряет интеграционные проекты любой
                    сложности.
                  </Text>
            ...
            <ListItem>
              <Stack direction={'row'} alignItems={'self-start'} mb={8}>
                ...
                <Box>
                  ...
                  <Text mb={3}>
                    Разработчик и производитель отечественной вычислительной техники, один из
                    лидеров в области импортозамещения. Продукция внесена в Единый реестр российской
            ...
            <ListItem>
              <Stack direction={'row'} alignItems={'self-start'} mb={8}>
                ...
                <Box>
                  ...
                  <Text mb={3}>
                    Компания RDW Technology – российский производитель вычислительного оборудования.
                    С 2015 года под брендом RDW Computers производит сертифицированную российскую
                    компьютерную технику, отвечающую требования цифровой безопасности
              ...
              <Stack direction={'row'} alignItems={'self-start'} mb={8}>
                ...
                <Box>
                  ...
                  <Text mb={3}>
                    ...
                    "Сколково", член АРПП "Отечественный софт" и РУССОФТ. Компания осуществляет
                    комплексные проекты в области хранения и управления данными на основе
              ...
              <Stack direction={'row'} alignItems={'self-start'} mb={8}>
                ...
                <Box>
                  ...
                  <Text mb={3}>
                    ...
                    компании является дистрибуция компьютерных комплектующих, серверов, ODM
                    продукции.
                  </Text>
              ...
              <Stack direction={'row'} alignItems={'self-start'} mb={8}>
                ...
                <Box>
                  ...
                  <Text mb={3}>
                    ...
                    Axoft — точка притяжения лучших технологических практик и сервисов,
                    аналитической и технической экспертизы для вендоров, партнеров, бизнеса,
