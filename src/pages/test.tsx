...
const ScrollableComponent:  FC<IScrollableComponentProps> = (props: IScrollableComponentProps) => {
...
const Info:  FC = (props: IInfoProps) => {
  return(
...
const Pin:  FC = () => {
  ...
  const ref:  MutableRefObject<HTMLInputElement> =  useRef<HTMLInputElement>(null);
...
const App:  FC = () => {
  const [userStatus, setUserStatusTo] =  useState<UserStatus>(UserStatus.LoggedOut);
